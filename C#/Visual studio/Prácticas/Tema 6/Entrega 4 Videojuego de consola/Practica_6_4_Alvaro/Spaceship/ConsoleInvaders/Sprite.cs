...
class Sprite
{
    ...
    {
        if (cx >= 1 && cx <= Configuracion.ANCHO_PANTALLA - imagen.Length &&
    ...
    public bool ColisionaCon(Sprite s)
    {
        ...
        // Colisionarán en horizontal si uno de los sprites está contenido
        // entre la coordenada X y la coordenada X + el tamaño del otro sprite
